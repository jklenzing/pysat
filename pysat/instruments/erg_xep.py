# -*- coding: utf-8 -*-
"""Supports the XEP instrument on the ERG (Arase) satellite.
...
fname = 'erg_xep_l2_omniflux_{year:04d}{month:02d}{day:02d}_v00_00.cdf'
...
load = cdw.load
basic_tag = {'dir': '/data/ergsc/satellite/erg/xep/l2/omniflux/',
